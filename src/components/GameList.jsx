...
function GameCard({
  ...
  return (
    <motion.article
      ...
      className="w-60 h-60 mt-20 relative flex-shrink-0"
    >
      ...
      {hasFavourite && (
        <section className="w-[90%] mx-auto mb-20">
          ...
          <div className="relative">
            <button
              onClick={scrollLeft}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-[#0b1326]/80 border border-[#00687A] text-amber-50 p-2 rounded-full hover:bg-[#00687A] transition-colors"
            >
              <IoChevronBackOutline className="w-5 h-5" />
            </button>
            <div
              ref={carouselRef}
              className="flex gap-5 overflow-x-auto scroll-smooth px-10 pb-5"
            ...
            <button
              onClick={scrollRight}
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-[#0b1326]/80 border border-[#00687A] text-amber-50 p-2 rounded-full hover:bg-[#00687A] transition-colors"
            >
